...
module.exports = function(option, log, path, urls, template) {
    ...
    // TODO (mkibbel): This accumulates all site data into RAM and then renders
    // everything at once. Improve overall performance and scalability by:
    // * Refactoring to render output from resolved promises as soon as possible. Don't
    //   collect everything and render at the end.
